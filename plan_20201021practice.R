...
options(rstudio_drake_cache = storr::storr_rds("/Users/martinl/Github/109-1-econDV/.practice2", hash_algorithm = "xxhash64"))
params=readRDS("/Users/martinl/Github/109-1-econDV/params_20201021practice.rds")
...
cache=drake::drake_cache(
  path="/Users/martinl/Github/109-1-econDV/.practice2"),...)
}
...
drake::loadd(...,
cache=drake::drake_cache(
  path="/Users/martinl/Github/109-1-econDV/.practice2"), envir = .GlobalEnv)
}
