...
# make plan -----------------
mk_plan_20201021practice = function(cachePath="/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2")
{
params=readRDS("/Users/martinl/Github/109-1-econDV/Weekly chart 1/params_20201021practice.rds")
...
library(drake)
options(rstudio_drake_cache = storr::storr_rds("/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2", hash_algorithm = "xxhash64"))
make(plan_20201021practice, cache=drake::drake_cache(path=cachePath))
}

vis_plan_20201021practice <- function(cachePath="/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2")
{
params=readRDS("/Users/martinl/Github/109-1-econDV/Weekly chart 1/params_20201021practice.rds")
...
rprojroot::is_rstudio_project -> pj
pj$make_fix_file()->root
drake::vis_drake_graph(plan_20201021practice, cache=drake::drake_cache(path=cachePath))
}
meta_plan_20201021practice=
list(
cachePath="/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2",
readd=function(t) {
drake::readd(t,cache=drake::drake_cache(path="/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2"))
},
clean=function(t=NULL) {
drake::clean(t,cache=drake::drake_cache(path="/Users/martinl/Github/109-1-econDV/Weekly chart 1/.practice2"))
})
