...
options(rstudio_drake_cache = storr::storr_rds("/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch", hash_algorithm = "xxhash64"))
# no params in the frontmatter
# plan_drake_myResearchPaper------------
plan_drake_myResearchPaper=drake::drake_plan(
# > plan begins -----------
...
mk_plan_drake_myResearchPaper= function()
{
library(readr)
library(ggplot2)
library(drake)
...
options(rstudio_drake_cache = storr::storr_rds("/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch", hash_algorithm = "xxhash64"))
# no params in the frontmatter
drake::make(plan_drake_myResearchPaper,
cache=drake::drake_cache(
  path="/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch"))
}
vis_plan_drake_myResearchPaper= function(...)
{
library(readr)
library(ggplot2)
library(drake)
...
options(rstudio_drake_cache = storr::storr_rds("/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch", hash_algorithm = "xxhash64"))
# no params in the frontmatter
drake::vis_drake_graph(plan_drake_myResearchPaper,
cache=drake::drake_cache(
  path="/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch"),...)
}
load_plan_drake_myResearchPaper= function(...)
{
drake::loadd(...,
cache=drake::drake_cache(
  path="/Users/martinl/Github/109-1-econDV/drake_plans/myResearchPaper/.myResearch"), envir = .GlobalEnv)
}
